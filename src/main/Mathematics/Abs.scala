object Abs {
  ...
  def absMin(numbers: List[Int]): Option[Int] = {
    numbers match {
    ...
    def main(args: Array[String]): Unit = {
      val num1 = -5
      val num2 = 7
      val numbers1 = List(-10, 5, -7, 8, -3, 2)
      val result1 = absMax(numbers1)
      val numbers2 = List(-10, 5, -7, 8, -3, 2)
      val result2 = absMin(numbers2)
